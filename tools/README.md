...
I want a reproducible way to re-create the benchmarks. This is still a bit of patchwork with installers, and I have only properly tested it on Ubuntu 22.04 on an x86_64 machine. I am not pretending this is a portable package manager.
