...
The runner uses warm-cache mode unless passwordless sudo is available for dropping Linux page cache. The current v0.2.5 run was collected in warm-cache mode.
